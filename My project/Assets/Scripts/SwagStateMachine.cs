...
public class SwagStateMachine<TLabel>
{
	#region  Types
	...
	public void AddState<TSubStateLabel>(TLabel label, SwagStateMachine<TSubStateLabel> subMachine,
